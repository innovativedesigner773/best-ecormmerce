...
import { Camera, Type, X, CheckCircle, AlertCircle, TestTube } from 'lucide-react';
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Scan or enter a barcode to add products automatically
              </CardDescription>
            </div>
              ...
              {scanMode === 'camera' && (
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    Note: Automatic scanning requires additional barcode detection library.
