  ...
  return (
    <footer className="bg-[#2C3E50] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <div className="bg-gradient-to-br from-[#87CEEB] to-[#4682B4] text-white p-2 rounded-xl shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="flex items-center space-x-2 text-sm text-[#87CEEB]">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#87CEEB] transition-colors p-2 hover:bg-[#4682B4]/20 rounded-lg">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#87CEEB]">Quick Links</h3>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#87CEEB]">Customer Service</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors hover:pl-2 duration-200">
                  Help Center
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-[#87CEEB]">Contact Info</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-[#87CEEB] mt-0.5 flex-shrink-0" />
                <div className="text-gray-300">
                  <div className="font-medium text-white mb-1">Durban Head Office</div>
              ...
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-[#87CEEB]" />
                <div>
                  <div className="text-white font-medium">info@bestbrightness.co.za</div>
                  <div className="text-sm text-gray-400">General Inquiries</div>
                </div>
              </div>
            </div>
            
            <div className="mt-6 p-4 bg-[#4682B4]/20 rounded-xl border border-[#87CEEB]/30">
              <div className="flex items-center space-x-2 mb-2">
                <Clock className="h-4 w-4 text-[#87CEEB]" />
                <h4 className="font-semibold text-[#87CEEB]">Business Hours</h4>
              </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#4682B4]/30 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
              <p className="text-gray-400 text-sm">
                © {currentYear} Best Brightness. All rights reserved.
              </p>
              <div className="flex items-center space-x-2 text-xs text-[#87CEEB]">
