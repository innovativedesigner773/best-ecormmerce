-- ============================================
-- REGISTRATION FIX: Resolve RLS Policy Issues (CORRECTED)
-- ============================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ Created: allow_signup_insert (CRITICAL FOR REGISTRATION)';
END $$;
...
DO $$
BEGIN
    RAISE NOTICE '✅ Created: allow_own_profile_update';
END $$;
...
-- Step 4: Verify the trigger function exists and is working
DO $$
BEGIN
    ...
    IF NOT EXISTS (
        ...
        RAISE NOTICE '⚠️ Trigger function handle_new_user does not exist, creating it...';
        ...
        RAISE NOTICE '✅ Created trigger function handle_new_user';
    ELSE
        RAISE NOTICE '✅ Trigger function handle_new_user already exists';
    END IF;
END $$;
